...
$sessionAccess = false;
$sessionGuest = false;
$_SESSION['sessionAccess'] = $sessionAccess;
$_SESSION['sessionGuest'] = $sessionGuest;
...
<body>
    ...
    <main>
        <?php if ($shopUser === false) { ?>
                    ...
                    <div class="row mb-4">
                        ...
                        <?php } elseif ($sessionAccess == true) { ?>
                            <div class="col-4 align-self-center">
                                <div class="card border-light p-5 text-center">
                                    ...
                                    <a class="text-decoration-none text-danger" href="./server/logout.php"><i class="fa-solid fa-right-from-bracket fa-2x"></i></a>
                        ...
                        <?php if ($sessionAccess == true || $sessionGuest == true) { ?>
                            <div class="col-4 align-self-center">
                                <div class="card border-light">
                                    <div class="card-body">
                                        <form action="./server/server.php" method="GET">
                                            <div class="row row-cols-1">
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="number_credit" name="number_credit" placeholder="#" minlenght="16" maxlenght="16" required <?php
                                                ...
                                                <div class="col">
                                                    <div class="form-floating mb-4">
                                                        <input type="text" class="form-control" id="c" name="holder_credit" placeholder="#" required <?php
                                                                                                                                                        if ($sessionAccess == true) {
                                                ...
                                                <div class="col">
                                                    <div class="form-floating mb-4">
                                                        <input type="text" class="form-control" id="cvv_credit" name="cvv_credit" placeholder="#" minlenght="3" maxlenght="3" required <?php
                                                                                                                                                                                        if ($sessionAccess == true) {
                                                ...
                                                <div class="col">
                                                    <div class="form-floating mb-4">
                                                        <input type="text" class="form-control" id="date_credit" name="date_credit" placeholder="#" minlenght="3" maxlenght="3" required <?php
                                                                                                                                                                                            if ($sessionAccess == true) {
            ...
            <?php } ?>
        <?php } elseif ($shopUser === true) { ?>
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <div class="text-success fs-3 p-5"  >
                            Acquisto effettuato l'acquisto con successo!!
                        </div>
                        <div class="mb-5">
                            <?php echo 'Il prodotto costava ' . $_SESSION['priceProduct'] . ' €'; ?>
                            <?php echo 'Hai pagato ' . $_SESSION['buyProduct'] . ' €'; ?>
                        </div>
                        <a class="text-decoration-none text-danger mt-5" href="./server/logout.php"><i class="fa-solid fa-right-from-bracket fa-2x"></i></a>
